...
public class TEmpleado  implements java.io.Serializable {
    ...
    public TEmpleado(int idEmpleado, String nombreEmpleado, String correoEmpleado, String duiEmpleado, String nitEmpleado,String direccionEmpleado, Date fechanacimientoEmpleado, BigDecimal salarioEmpleado, Date fechaingresoEmpleado, String telefonoEmpleado, String celularEmpleado, String sexoEmpleado, String apellidoEmpleado, Boolean estadoEmpleado, Boolean estadoE,Boolean estadoS, String fotoEmpleado, String lugarNacimientoEmpleado, Integer tipoEmpleado, Boolean estadoSocio, Set TCapacitacions, Set TAsesorias, Set TEmpleadoCargos, Set TOcupacions, Set TComentarios, Set TSugerencias, Set TActivoFijos, Set TUsuarios, Set TEmpleadoAreas) {
       this.idEmpleado = idEmpleado;
