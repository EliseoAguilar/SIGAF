...
public class CooperativaBean extends Actividad {
    ...
    private Boolean emptyLogo;
    private Boolean emptyCredencial;
    private Boolean emptyNit;
    private String msgLogo;
    private String msgCredencial;
    ...
    public Boolean getEmptyLogo() {
        return emptyLogo;
    }

    public void setEmptyLogo(Boolean emptyLogo) {
        this.emptyLogo = emptyLogo;
    }

    public Boolean getEmptyCredencial() {
        return emptyCredencial;
    }

    public void setEmptyCredencial(Boolean emptyCredencial) {
        this.emptyCredencial = emptyCredencial;
    }

    public Boolean getEmptyNit() {
        return emptyNit;
    }

    public void setEmptyNit(Boolean emptyNit) {
        this.emptyNit = emptyNit;
    }
    ...
    public String getMsgCredencial() {
        return msgCredencial;
    }

    public void setMsgCredencial(String msgCredencial) {
        this.msgCredencial = msgCredencial;
    }
    ...
    public void updateListaCooperativas() {
...
//VALIDACIONES
    ...
    public void crear() {
        ...
        auxBitacora.setAccionBitacora("Agregar cooperativa");
        auxBitacora.setDatosBitacora("Nombre: " + this.Entidad.getNombreEntidad() + ", Código: " + this.Entidad.getCodigoEntidad());
        auxBitacora.setHoraBitacora(new Date());
        auxBitacora.setFechaBitacora(new Date());
        auxBitacora.setIdTableBitacora(this.Entidad.getIdEntidad());
    ...
    public void modificar() {
        ...
        TBitacora auxBitacora = new TBitacora();
        auxBitacora.setTableBitacora("t_entidad");
        auxBitacora.setAccionBitacora("Modificar cooperativa");
        auxBitacora.setDatosBitacora("Nombre: " + this.Entidadeleccionada.getNombreEntidad() + ", Código: " + this.Entidadeleccionada.getCodigoEntidad());
        auxBitacora.setHoraBitacora(new Date());
        auxBitacora.setFechaBitacora(new Date());
    ...
    public void darDeBaja() {
        ...
        TBitacora auxBitacora = new TBitacora();
        auxBitacora.setTableBitacora("t_entidad");
        auxBitacora.setAccionBitacora("Dar de baja cooperativa");
        auxBitacora.setDatosBitacora("Nombre: " + this.Entidadeleccionada.getNombreEntidad() + ", Código: " + this.Entidadeleccionada.getCodigoEntidad());
        auxBitacora.setHoraBitacora(new Date());
        auxBitacora.setFechaBitacora(new Date());
        auxBitacora.setIdTableBitacora(this.Entidadeleccionada.getIdEntidad());
...
//
    ...
    public void validarFormularioEntidad() {
        ...
        if (this.emptyLogo == true) {
            this.msgLogo = "El logo es requerido";
            this.estadoFormulario = false;
        } else {
            this.msgLogo = "";
        }
        if (this.emptyNit == true) {
            this.msgNit = "El nit es requerido";
            this.estadoFormulario = false;
        } else {
            this.msgNit = "";
        }
        if (this.emptyCredencial == true) {
            this.msgCredencial = "La credencial es requerida";
            this.estadoFormulario = false;
        } else {
            this.msgCredencial = "";
        }
    ...
    public void validarFormularioModificar() {
        ...
        if (this.Entidadeleccionada.getNombreEntidad().length() < 3) {
            this.msgNombreE = "El nombre debe contener como minimo 3 caracteres";
            this.estadoFormularioE = false;
        } else {
            this.msgNombreE = "";
        }
        if (this.Entidadeleccionada.getAbreviacionEntidad().length() < 3) {
            this.msgAbreviacionE = "El nombre corto debe contener como minimo 3 caracteres";
            this.estadoFormularioE = false;
        } else {
            this.msgAbreviacionE = "";
        }
        if (this.Entidadeleccionada.getNitEntidad().length() < 14) {
            this.msgNitE = "El NIT es requerido";
            this.estadoFormularioE = false;
        } else {
            this.msgNitE = "";
        }
        if (this.Entidadeleccionada.getGiroEntidad().length() < 3) {
            this.msgGiroE = "El giro debe contener como minimo 3 caracteres";
            this.estadoFormularioE = false;
        } else {
            this.msgGiroE = "";
        }
        if (this.Entidadeleccionada.getNombreRepresentanteEntidad().length() < 3) {
            this.msgRepresentanteE = "El nombre debe contener como minimo 3 caracteres";
            this.estadoFormularioE = false;
        } else {
            this.msgRepresentanteE = "";
        ...
        if (this.Entidadeleccionada.getNitRepresentanteEntidad().length() < 14) {
            this.msgNitRepresentanteE = "El NIT debe contener 14 caracteres";
            this.estadoFormularioE = false;
        } else {
            this.msgNitRepresentanteE = "";
        }
        if (this.Entidadeleccionada.getMisionEntidad().length() < 10) {
            this.msgMisionE = "La mision es requerida";
            this.estadoFormularioE = false;
        } else {
            this.msgMisionE = "";
        }
        if (this.Entidadeleccionada.getVisionEntidad().length() < 10) {
            this.msgVisionE = "La vision es requerida";
            this.estadoFormularioE = false;
        } else {
            this.msgVisionE = "";
        }
        if (this.Entidadeleccionada.getTelefonoEntidad().length() < 8) {
            this.msgTelefonoE = "El telefono debe contener 8 caracteres";
            this.estadoFormularioE = false;
        } else {
            this.msgTelefonoE = "";
        }
        if (this.Entidadeleccionada.getCelularEntidad().length() < 8) {
            this.msgMovilE = "El movil debe contener 8 caracteres";
            this.estadoFormularioE = false;
        } else {
            this.msgMovilE = "";
        }
        if (this.Entidadeleccionada.getDireccionEntidad().length() < 8) {
            this.msgDireccionE = "La direcion es requeridad";
            this.estadoFormularioE = false;
        } else {
            this.msgDireccionE = "";
    ...
    public void verReporteCooperativa() throws SQLException, JRException, IOException {
        ...
        TBitacora auxBitacora = new TBitacora();
        auxBitacora.setTableBitacora("t_entidad");
        auxBitacora.setAccionBitacora("Generar reporte cooperativa");
        auxBitacora.setDatosBitacora("Nombre: " + this.Entidadeleccionada.getNombreEntidad() + ", Código: " + this.Entidadeleccionada.getCodigoEntidad());
        auxBitacora.setHoraBitacora(new Date());
        auxBitacora.setFechaBitacora(new Date());
        auxBitacora.setIdTableBitacora(this.Entidadeleccionada.getIdEntidad());
    ...
    public void verNit() throws SQLException, JRException, IOException {
        this.getConexion();
        Map<String, Object> parametros = new HashMap();
        parametros.put("id_entidad", this.Entidadeleccionada.getIdEntidad());
        File jasper = new File(FacesContext.getCurrentInstance().getExternalContext().getRealPath("/Reportes/administracion/documentoNit.jasper"));
        byte[] bytes = JasperRunManager.runReportToPdf(jasper.getPath(), parametros, this.getConn());
        System.out.println(bytes.length);
        HttpServletResponse response = (HttpServletResponse) FacesContext.getCurrentInstance().getExternalContext().getResponse();
        response.setContentType("application/pdf");
    ...
    public void verCredencial() throws SQLException, JRException, IOException {
        this.getConexion();
        Map<String, Object> parametros = new HashMap();
        parametros.put("id_entidad", this.Entidadeleccionada.getIdEntidad());
        File jasper = new File(FacesContext.getCurrentInstance().getExternalContext().getRealPath("/Reportes/administracion/documentoCredencial.jasper"));
        byte[] bytes = JasperRunManager.runReportToPdf(jasper.getPath(), parametros, this.getConn());
        System.out.println(bytes.length);
        HttpServletResponse response = (HttpServletResponse) FacesContext.getCurrentInstance().getExternalContext().getResponse();
        response.setContentType("application/pdf");
    ...
    public void verReporteCooperativaPDF() throws SQLException, JRException, IOException {
        ...
        TBitacora auxBitacora = new TBitacora();
        auxBitacora.setTableBitacora("t_entidad");
        auxBitacora.setAccionBitacora("Generar PDF cooperativa");
        auxBitacora.setDatosBitacora("Nombre: " + this.Entidadeleccionada.getNombreEntidad() + ", Código: " + this.Entidadeleccionada.getCodigoEntidad());
        auxBitacora.setHoraBitacora(new Date());
        auxBitacora.setFechaBitacora(new Date());
        auxBitacora.setIdTableBitacora(this.Entidadeleccionada.getIdEntidad());
